...
class ResnetBuilder(object):
    ...
    @staticmethod
    def build_bone(input, num_outputs, block_fn, repetitions):
        conv1 = _conv_bn_relu(filters=64, kernel_size=(7, 7), strides=(2, 2))(input)
        pool1 = MaxPooling2D(pool_size=(3, 3), strides=(2, 2), padding="same")(conv1)
    ...
    @staticmethod
    def build_resnet_18_bone(input_shape, num_outputs):
        return ResnetBuilder.build_bone(input_shape, num_outputs, basic_block, [2, 2, 2, 2])
    ...
    @staticmethod
    def build_resnet_finger3(input_shape, num_outputs):
